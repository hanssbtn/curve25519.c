...
int32_t curve25519_key_divmod(const curve25519_key_t *const restrict k1, const curve25519_key_t *const restrict k2, curve25519_key_t *const restrict q, curve25519_key_t *const restrict r);
